...
object ColorUtil {
    ...
    fun randomImage(): String {
        Random.run {
            val nextInt = nextInt(IMAGE_URL.size)
            return IMAGE_URL[nextInt]
        }
    }
